...
USER_PROMPT = "These are the frames from the video. Focus your analysis on Donovan Ezeiruaku. Provide player evaluation and scouting insights."
...
with tab1:
    with st.sidebar:
        ...
        aoai_model_name = st.text_input("AOAI Model Name/Deployment", value=os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME2", "gpt-4.1-nano"))
